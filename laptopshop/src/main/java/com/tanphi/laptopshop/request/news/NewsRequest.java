package com.tanphi.laptopshop.request.news;
...
public class NewsRequest {
	...
	@NotNull(message = "Nhập tên tiêu đề")
	@NotEmpty(message = "Nhập tên tiêu đề")
	...
	@NotNull(message = "Nhập nội dung")
	@NotEmpty(message = "Nhập nội dung")
	private String content;
	@NotNull(message = "Chọn thêm hình ảnh")
	@NotEmpty(message = "Chọn thêm hình ảnh")
